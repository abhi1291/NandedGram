...
public class ContactCategoryViewHolder extends ParentViewHolder {
    ...
    public ContactCategoryViewHolder(View itemView) {
        super(itemView);
    ...
    public void bind(ContactCategory contactCategory) {
        mMovieTextView.setText(contactCategory.getName());
    }
