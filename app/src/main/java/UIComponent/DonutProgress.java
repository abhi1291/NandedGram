...
public class DonutProgress extends View {
    ...
    protected Paint textPaint,suffixPaint;
    ...
    public DonutProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_stroke_width = Util.dp2px(getResources(), 10);
        default_suffix_padding = Util.dp2px(getResources(), 0);
        default_inner_bottom_text_size = Util.sp2px(getResources(), 18);
    ...
    protected void initPainters() {
        ...
        suffixPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
        suffixPaint.setColor(textColor);
        suffixPaint.setTextSize(suffixTextSize);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        suffixTextSize = attributes.getDimension(R.styleable.DonutProgress_donut_suffix_text_size, default_text_size);
        ...
        suffixTextPadding = attributes.getDimension(R.styleable.DonutProgress_donut_suffix_text, default_suffix_padding);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(text)) {
            /** DonutProgress code to set text commented below **/
            float textHeight = textPaint.descent() + textPaint.ascent();
            float textBaseline = (getHeight() - textHeight) / 2.0f;
            float textX = (getWidth() - (textPaint.measureText(text) + suffixPaint.measureText(suffixText))) / 2.0f;
            canvas.drawText(text, textX, textBaseline, textPaint);

            float suffixHeight = (suffixPaint.descent()) + (suffixPaint.ascent());
            canvas.drawText(suffixText, (textX + textPaint.measureText(text)), textBaseline + textHeight - suffixHeight/2.0f, suffixPaint);
//            canvas.drawText("%", (getWidth() + textPaint.measureText(text)) / 2.0f, textBaseline + textHeight - (suffixHeight), textPaint);
            /** DonutProgress set text code ends here **/
        }
    }
